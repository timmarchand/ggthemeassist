    ...
    miniTabstripPanel(selected = 'Panel & Background',
                      ...
                      miniTabPanel("Panel & Background", icon = icon('sliders'),
                                   ...
                                   miniContentPanel(scrollable = TRUE,
                                                    ...
                                                    fillRow(height = line.height, width = '100%',
                                                            numericInput('plot.background.size', label = 'Size', step = 0.1, value = default$plot.background$linewidth, width = input.width),
                                                            numericInput('panel.background.size', label = 'Size', step = 0.1, value = default$panel.background$linewidth, width = input.width),
                                                            numericInput('panel.grid.major.size', label = 'Size', step = 0.1, value = default$panel.grid.major$linewidth, min = 0, width = input.width),
                                                            numericInput('panel.grid.minor.size', label = 'Size', step = 0.1, value = default$panel.grid.minor$linewidth, min = 0, width = input.width)
                                                    ),
                                                    fillRow(height = line.height, width = '100%',
                      ...
                      miniTabPanel("Axis", icon = icon('sliders'),
                                   ...
                                   miniContentPanel(scrollable = TRUE,
                                                    ...
                                                    fillRow(height = line.height, width = '100%',
                                                            ...
                                                            numericInput('axis.line.size', label = 'Size', step = 0.1, value = default$axis.line$linewidth, min = 0, width = input.width),
                                                            numericInput('axis.ticks.size', label = 'Size', step = 0.1, value = default$axis.ticks$linewidth, min = 0, width = input.width)
                                                    ),
                                                    fillRow(height = line.height, width = '100%',
                      ...
                      miniTabPanel("Title, Label & Facet", icon = icon('sliders'),
                                   ...
                                   miniContentPanel(scrollable = TRUE,
                                                    fillRow(height = heading.height, width = '100%',
                                                            ...
                                                            headingOutput('Facets Background'),
                                                            headingOutput('Facets Text')
                                                    ),
                                                    fillRow(height = line.height, width = '100%',
                                                    ...
                                                    fillRow(height = line.height, width = '100%',
                                                            ...
                                                            numericInput('strip.background.size', label = 'Size', step = 0.1, value = default$strip.background$linewidth, width = input.width),
                      ...
                      miniTabPanel("Legend", icon = icon('sliders'),
                                   ...
                                   miniContentPanel(scrollable = TRUE,
                                                    ...
                                                    fillRow(height = line.height, width = '100%',
                                                            ...
                                                            numericInput('legend.background.size', label = 'Size', step = 0.1, value = default$legend.background$linewidth, width = input.width),
                                                            numericInput('legend.key.size', label = 'Size', step = 0.1, value = default$legend.key$linewidth, width = input.width)
                                                    ),
                                                    fillRow(height = line.height, width = '100%',
                                                            conditionalPanel(
                                                              condition = "input['legend.position'] == 'XY'",
      ...
      gg <- gg_original +
        ...
        theme(
          ...
          axis.line = element_line(
            ...
            linewidth = as.numeric(input$axis.line.size)),
          axis.ticks = element_line(
            linetype = input$axis.ticks.type,
            colour = input$axis.ticks.colour,
            linewidth = as.numeric(input$axis.ticks.size)),
          ...
          panel.grid.major = element_line(
            ...
            linewidth = as.numeric(input$panel.grid.major.size)),
          panel.grid.minor = element_line(
            linetype = input$panel.grid.minor.type,
            colour = input$panel.grid.minor.colour,
            linewidth = as.numeric(input$panel.grid.minor.size)),
